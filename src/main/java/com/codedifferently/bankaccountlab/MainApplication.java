...
public class MainApplication {
    ...
    public static void main(String[] args) {
        Checkings acount1 = new Checkings(1234567, "Bob", 20.00, 1234, 100.00, 0.5);
        Account.add(acount1);
    ...
    public static Checkings createCheckingsAcc() {
        ...
        return new Checkings(accountNum, name, fees, pin, balance, rate);
    }

    public static Savings createSavingsAcc() {
        System.out.print("Enter an acount number of 8 numbers:");
        Integer accountNum = scanner.nextInt();
        ...
        System.out.print("\nYour balance starts at:" + balance + "\nand your account rate is:" + rate);
        System.out.print("\nAccount had been created!");
        return new Savings(accountNum, name, fees, pin, balance, rate);
    }

    public static Business createBusinessAcc() {
        System.out.print("Enter an acount number of 8 numbers:");
        Integer accountNum = scanner.nextInt();
        ...
        System.out.print("\nAccount had been created!");
        return new Business(accountNum, name, fees, pin, balance, taxId, company);
